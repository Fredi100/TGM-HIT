 ...
 * @version 2011-10-13
 */
public class A10_RechnenMitJava {
    public static void main(String[] args) {
        ...
        zahl1 = 60; //Diese Variable enthält den Wert der Variable der ersten Deklaration
        zahl2 = 7; //Diese Variable enthält den Wert der Variable der zweiten Deklaration
